...
export async function load<Schema extends z.ZodType>(
  ...
  // TODO: a source starting with http:// or https:// is fetched (Accept: application/json);
  //   a status that isn't ok -> `<host> answered <status>`.
  //   Anything else is a local file: readFile it and JSON.parse it.
  // TODO: either way, schema.parse the data and return it
