...
export function mountRiderRush(root: ParentNode, options: RiderRushOptions): () => void {
  ...
  // TODO: find #share (HTMLButtonElement) and #toast (HTMLElement)
  ...
  function syncControls(): void {
    ...
    // TODO: #share only shows after a crash with a score above 0
  ...
  // TODO: #share click: await shareScore(score, options.pageUrl, options.shareTarget),
  //   then put shareMessage(result) in #toast
