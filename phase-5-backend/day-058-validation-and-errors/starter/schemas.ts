...
// TODO: PATCH takes any of the same fields, at least one, and nothing else.
//   VendorInputSchema.partial(), then .strict() (so a typo like "prize" is an error, not ignored),
//   then .refine(...) with the message "Send at least one field to change"
